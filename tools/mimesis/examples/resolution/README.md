...
The end state of [`../../docs/tutorial.md`](../../docs/tutorial.md): a Eunoia
...
| [`Resolution.eos`](Resolution.eos) | the semantics. **Not compiled here** — see the tutorial's [what was checked](../../docs/tutorial.md#what-was-checked-and-what-was-not) |
