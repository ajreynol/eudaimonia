...
Rewrites only the HTML file named by --out; never changes the input measurements.
"""
...
<!-- Generated by Euthyna report_site/plot-rules.py. Rewritten whole on each run. -->
<html lang="en">
<head>
<meta charset="utf-8">
