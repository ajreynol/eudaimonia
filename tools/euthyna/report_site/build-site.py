...
Rewrites HTML pages and downloadable copies under --out (default: scratch/site/).
Never writes to the measurement inputs or the implementation directories by default.
"""
...
spec = importlib.util.spec_from_file_location("plot_rules", ROOT / "report_site/plot-rules.py")
...
<!-- Generated by Euthyna report_site/build-site.py. Rewritten whole on each run. -->
<html lang="en">
<head>
<meta charset="utf-8">
...
<a href="{SOURCE_URL}/measurement/data/snapshots">Source data</a></footer>
</main></body></html>
'''
...
def main() -> None:
    ...
    parser.add_argument("--snapshots", type=Path, default=ROOT / "measurement/data/snapshots")
    parser.add_argument("--out", type=Path, default=ROOT / "scratch/site",
                        help="output directory (default: Euthyna's scratch/site/)")
